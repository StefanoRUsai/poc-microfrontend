...
interface Events {
  ...
  token: () => void,
  payment: (prodotto: string, prezzo: number) => void,
}
...
function App() {
  ...
  return (
    <>
      ...
      <Route path="/home" exact element={   <React.Suspense fallback="Loading...">
        <HomePage emitter={emitter}/>
      </React.Suspense>} />
      <Route path="/appone" exact  element={   <React.Suspense fallback="Loading...">
        <AppOne emitter={emitter}/>
      </React.Suspense>} />
      <Route path="/vue" exact  element={   <React.Suspense fallback="Loading...">
        <Vue emitter={emitter}/>
      </React.Suspense>} />
        </Routes>
